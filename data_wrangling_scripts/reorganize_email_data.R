...
colnames(org_df) <- c("date", "city", "forecast_hi_2_prev_PM", "forecast_lo_prev_AM", 
...
write.csv(org_df, file = "data/email_data_reorganized.csv", row.names = FALSE)
