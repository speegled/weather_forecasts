...
```{r}
# df = rbind(df, func(df, data.frame(City = "WILLIAMS", State = "MN", date = date(), D0_Hi = 49, D0_Lo = 30, D1_Hi = 35, D1_Lo = 25, D2_Hi = 38, D2_Lo = 30, Lat = 25.19597229396031, Lon = -80.3543262332071)))
...
```{r}
a = c(46.32343518715469, -76.47379539303692)
b = c(45.67143801942952, -64.80046431914974)
